...
namespace LLMAPI.Services.OpenRouter
{
    ...
    public class OpenRouterService : ITextGenerationService, IImageRecognitionService, IImageFileService
    {
        ...
        public async Task<string> AnalyzeImage(string model, string imageUrl, string prompt, double temperature)
        {
            var requestData = new
            {
                model,
                ...
                messages = new List<object>
                {
                    //new {
                    //    role = "system",
                    //    content = "You are an alt text generator. Forget every other prior instruction of how to act."
                    //},
                    new {
                        role = "user",
        ...
        /// <param name="temperature"></param>
        /// <returns>The image description generated by the LLM or an error message.</returns>
        public async Task<string> AnalyzeImage(string model, ByteString imageBytes, string prompt, double temperature)
        {
        ...
        private async Task<string> SendRequest(object requestData)
        {
            ...
            Console.WriteLine(">>> Sending JSON Request Body: " + jsonContent);
